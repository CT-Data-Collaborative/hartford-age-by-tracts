...
colnames(denomenator.df) <- c("Id", "y_2011-2015")
WriteDFToTable(denomenator.df, "population-total.csv")
...
colnames(population.young.df) <- c("Id", "y_2011-2015")
...
colnames(population.elderly.df) <- c("Id", "y_2011-2015")
...
colnames(population.working.df) <- c("Id", "y_2011-2015")
...
colnames(population.median.df) <- c("Id", "y_2011-2015")
